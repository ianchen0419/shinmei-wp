<?php /* Template Name: _en_material */ ?>
<?php get_header();?>
...
<main id="contact">
	<div class="wrapper-size">
		...
		<p>Thank you for your interest in downloading Shinmei's catalog.<br>Please fill in the required items and press the "Next" button.<br>After entering the information, the document download page is displayed.</p>
...
<script>
	var Acheckbox_first=document.querySelectorAll('input[name*="your_purpose"]')[0];
	var Bchcekbox_first=document.querySelectorAll('input[name*="your_schedule"]')[0];
