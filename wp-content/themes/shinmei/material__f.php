...
<main id="contact">
	<div class="wrapper-size">
		...
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/thermal-1.pdf" class="blue-button download-button <?php echo isset($_POST['your_data1'])?'':'disabled'; ?>" download="卓上型ダイレクトサーマルプリンター ＳＭＰ-３５０シリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>卓上型ダイレクトサーマルプリンター<br>ＳＭＰ-３５０シリーズ</span>
			</a>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/thermal-2.pdf" class="blue-button download-button <?php echo isset($_POST['your_data2'])?'':'disabled'; ?>" download="卓上型一体ダイレクトサーマルプリンター ＡＦＢ-３５０シリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>卓上型一体ダイレクトサーマルプリンター<br>ＡＦＢ-３５０シリーズ</span>
			</a>
		</div>
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/thermal-3.pdf" class="blue-button download-button <?php echo isset($_POST['your_data3'])?'':'disabled'; ?>" download="両面同時ダイレクトサーマルプリンター ＣＰＳ-ＵＢシリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>両面同時ダイレクトサーマルプリンター<br>ＣＰＳ-ＵＢシリーズ</span>
			</a>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/thermal-4.pdf" class="blue-button download-button <?php echo isset($_POST['your_data4'])?'':'disabled'; ?>" download="小袋用ダイレクトサーマルプリンター ＣＰＳ-８５Ｅシリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>小袋用ダイレクトサーマルプリンター<br>ＣＰＳ-８５Ｅシリーズ</span>
			</a>
		</div>
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/thermal-5.pdf" class="blue-button download-button <?php echo isset($_POST['your_data5'])?'':'disabled'; ?>" download="ロールフィルムプリントシステム ＲＰＳシリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>ロールフィルムプリントシステム<br>ＲＰＳシリーズ</span>
			</a>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/thermal-6.pdf" class="blue-button download-button <?php echo isset($_POST['your_data6'])?'':'disabled'; ?>" download="包装機対応ダイレクトサーマルプリンター ＳＣＳ-４１０シリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>包装機対応ダイレクトサーマルプリンター<br>ＳＣＳ-４１０シリーズ</span>
			</a>
		</div>
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/thermal-7.pdf" class="blue-button download-button <?php echo isset($_POST['your_data7'])?'':'disabled'; ?>" download="大袋用ダイレクトサーマルプリンター ＳＭＰ-６５０シリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
		...
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/egg-1.pdf" class="blue-button download-button <?php echo isset($_POST['your_data8'])?'':'disabled'; ?>" download="鶏卵中身有無装置">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>鶏卵パック上貼り機<br>ＡＬＳ-１０００ＳＣＳシリーズ</span>
			</a>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/egg-2.pdf" class="blue-button download-button <?php echo isset($_POST['your_data9'])?'':'disabled'; ?>" download="インパックラベル日付印字プリンター ＣＰＳ-８５ＥⅢシリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>インパックラベル日付印字プリンター<br>ＣＰＳ-８５ＥⅢシリーズ</span>
			</a>
		</div>
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/egg-3.pdf" class="blue-button download-button <?php echo isset($_POST['your_data10'])?'':'disabled'; ?>" download="鶏卵中身有無装置">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>鶏卵中身有無装置</span>
			</a>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/egg-4.pdf" class="blue-button download-button <?php echo isset($_POST['your_data11'])?'':'disabled'; ?>" download="鶏卵ライン用日付検査カメラ">
				<i class="fa fa-file-text-o fa-fw"></i>
		...
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/feeder-1.pdf" class="blue-button download-button <?php echo isset($_POST['your_data12'])?'':'disabled'; ?>" download="フィーダー・スタッカー">
				<i class="fa fa-file-text-o fa-fw"></i>
		...
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/stamper-1.pdf" class="blue-button download-button <?php echo isset($_POST['your_data13'])?'':'disabled'; ?>" download="自動汎用計数押印機 ＣＳシリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>自動汎用計数押印機<br>ＣＳシリーズ</span>
			</a>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/stamper-2.pdf" class="blue-button download-button <?php echo isset($_POST['your_data14'])?'':'disabled'; ?>" download="手形振出・裏書用押印機 ＣＳ-ＢⅡシリーズ">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>手形振出・裏書用押印機<br>ＣＳ-ＢⅡシリーズ</span>
			</a>
		</div>
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/stamper-3.pdf" class="blue-button download-button <?php echo isset($_POST['your_data15'])?'':'disabled'; ?>" download="パンフレットスタンパー">
				<i class="fa fa-file-text-o fa-fw"></i>
		...
		<div>
			<a href="<?php bloginfo('template_directory') ?>/inc/img/download/others-1.pdf" class="blue-button download-button <?php echo isset($_POST['your_data16'])?'':'disabled'; ?>" download="ラベル / シール">
				<i class="fa fa-file-text-o fa-fw"></i>
				<span>ラベル / シール</span>
			</a>
		</div>
