<?php /* Template Name: _en_inquiry-004__f */ ?>
<?php get_header();?>
	...
	<div class="wrapper-size">
		...
		if ($_SESSION['finish']==true){
			...
			$mailer->Body = 
				...
				'【Daily usage for printing object】'._post('copy_type')."<br>".
				'【Label type】'._post('label_type')."<br>".
				'【Label size / thickness】'._post('label_size')."<br>".
			...
			$mailer->Body = 
				...
				'【被写体の種類】'._post('copy_type')."<br>".
				'【ラベルの種類】'._post('label_type')."<br>".
				'【ラベルのサイズ・厚さ】'._post('label_size')."<br>".
