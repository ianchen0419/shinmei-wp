<?php /* Template Name: inquiry-001__c */ ?>
<?php get_header();?>
		...
		<?php }?>
			<div class="form-center">
				...
				<div class="contact-item less-checkbox">
					...
					<label class="checkbox">
						<input type="checkbox" readonly disabled name="pillow_type[]" value="<?php echo (get_current_blog_id()==1)?'縦ピロー':'Vertical pillow' ?>" <?php echo isset($_POST['pillow_type1'])?'checked':''; ?> />
						<i class="fa fa-check"></i>
						<span><?php echo (get_current_blog_id()==1)?'縦ピロー':'Vertical pillow' ?></span>
					</label>
					<label class="checkbox">
						<input type="checkbox" readonly disabled name="pillow_type[]" value="<?php echo (get_current_blog_id()==1)?'横ピロー':'Horizontal pillow' ?>" <?php echo isset($_POST['pillow_type2'])?'checked':''; ?> />
						<i class="fa fa-check"></i>
				...
				<div class="contact-item less-checkbox">
					...
					<label class="checkbox">
						<input type="checkbox" readonly disabled name="operate_method[]" value="<?php echo (get_current_blog_id()==1)?'連続式':'Continuous type' ?>" <?php echo isset($_POST['operate_method1'])?'checked':''; ?> />
						<i class="fa fa-check"></i>
						<span><?php echo (get_current_blog_id()==1)?'連続式':'Continuous type' ?></span>
					</label>
					<label class="checkbox">
						<input type="checkbox" readonly disabled name="operate_method[]" value="<?php echo (get_current_blog_id()==1)?'間欠式':'Intermittent type' ?>" <?php echo isset($_POST['operate_method2'])?'checked':''; ?> />
						<i class="fa fa-check"></i>
				...
				<div class="contact-item less-checkbox">
					...
					<label class="checkbox">
						<input type="checkbox" readonly disabled name="print_content[]" value="<?php echo (get_current_blog_id()==1)?'日付専用':'Date only' ?>" <?php echo isset($_POST['print_content1'])?'checked':''; ?> />
						<i class="fa fa-check"></i>
						<span><?php echo (get_current_blog_id()==1)?'日付専用':'Date only' ?></span>
					</label>
					<label class="checkbox">
						<input type="checkbox" readonly disabled name="print_content[]" value="<?php echo (get_current_blog_id()==1)?'製造者、原材料などその他の一括表示':'Other collective display of manufacturers, raw materials, etc.' ?>" <?php echo isset($_POST['print_content2'])?'checked':''; ?> />
						<i class="fa fa-check"></i>
