<?php /* Template Name: inquiry-004__c */ ?>
<?php get_header();?>
...
<main id="contact">
	<div class="wrapper-size">
		...
		<?php }else{ ?>
		<form action="<?php bloginfo('url') ?>/material/inquiry-004/finish" method="POST" onsubmit="goMail(this, event);">	
		<?php }?>
			<div class="form-center">
				...
				<div class="contact-item">
					<div class="title"><?php echo (get_current_blog_id()==1)?'被写体の種類':'Object type' ?></div>
					<input type="text" readonly disabled name="copy_type" value="<?php echo $_POST['copy_type'] ?>" />
				</div>
				<div class="contact-item">
					<div class="title"><?php echo (get_current_blog_id()==1)?'ラベルの種類':'Label type' ?></div>
					<input type="text" readonly disabled name="label_type" value="<?php echo $_POST['label_type'] ?>" />
				</div>
				<div class="contact-item">
					<div class="title"><?php echo (get_current_blog_id()==1)?'ラベルのサイズ・厚さ':'Label size / thickness' ?></div>
					<input type="text" readonly disabled name="label_size" value="<?php echo $_POST['label_size'] ?>" />
				</div>
				<div class="contact-item">
