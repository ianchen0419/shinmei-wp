...
<main id="contact">
	<div class="wrapper-size">
		...
		<form action="<?php bloginfo('url') ?>/material/inquiry-002/conf" method="POST" class="mar_top40">
			...
			<div class="contact-item">
				<div class="title">現在の印字・表示方法</div>
				<input type="text" name="print_method" placeholder="手貼り、プレ印刷など" />
			</div>
			<div class="contact-item">
				<div class="title">印字対象の1日の使用量</div>
				<input type="text" name="use_amount" placeholder="何枚" />
			</div>
			<div class="contact-item">
				<div class="title">印字対象の材質</div>
				<input type="text" name="print_material" placeholder="＊袋：ポリ、アルミ等　＊ラベル：コード紙、合成紙等　＊その他" />
			</div>
			<div class="contact-item">
				<div class="title">印字対象の機能</div>
				<input type="text" name="print_function" placeholder="チェック付きなど" />
			</div>
			<div class="contact-item">
				<div class="title">印字対象のサイズ・厚さ</div>
