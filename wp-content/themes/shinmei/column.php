...
<main id="contact">
	<div class="wrapper-size">
		...
		<div class="deco-title">
			<h3><?php echo (get_current_blog_id()==1)?'GS1-128（旧称UCC/EAN-128）':'GS1-128 (formerly called UCC / EAN-128)' ?>sss</h3>
		</div>
		...
		<figure class="trademark-area">
			...
			<figcaption>
				<p><?php echo (get_current_blog_id()==1)?'必要な時に必要なだけ１個からその場で印字ができるオンデマンドのダイレクトサーマルプリンターでのコード印字は、QRコードの用途を更に広げています。':'Code printing with an on-demand thermal printer, which can print on the spot from one piece when needed, further expands the application of QR codes.' ?></p>
