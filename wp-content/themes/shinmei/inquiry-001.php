		...
		<form action="<?php bloginfo('url') ?>/material/inquiry-001/conf" method="POST" class="mar_top40">
			<div class="form-center">
				...
				<div class="contact-item">
					...
					<input type="text" name="machine_detail" placeholder="メーカー名・形式名" />
				</div>
				<div class="contact-item less-checkbox">
				...
				<div class="contact-item">
					...
					<input type="text" name="print_pitch" placeholder="　mm〜　mm" />
				</div>
				<div class="contact-item">
					<div class="title">印字ショット数</div>
					<input type="text" name="print_short" placeholder="　回 / 　分" />
				</div>
				<div class="contact-item">
