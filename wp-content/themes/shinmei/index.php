...
<main id="contact" class="font-bold">
	<section>
		<div class="wrapper-size">
			<p class="mar_top40"><?php echo (get_current_blog_id()==1)?'シンメイは、製造工場の皆様へ産業用プリンターの製造販売、サービス、メンテナンスを行っています。軟包装や袋包装への直接印字や印刷、ラベル印刷の事なら産業用プリンターのシンメイへいつでもどんな事でもご相談下さい。シンメイの産業用プリンターは、製造工場における様々な製品の軟包装や袋包装への製造日、賞味期限、バーコード、QRコードなどの印字そして識別マーク、原材料、成分などの表示を正確に印刷する産業用プリンターです。皆様の製造工場における様々なご相談を心からお待ちしております。':'We are providing industrial printer and service, maintenance for manufacturing factory.<br>Please contact us Shinmei Co.,Ltd for industrial printer anytime and anything about direct printing or labeling on flexible packaging and bag packaging. Shinmei Co.,Ltd industrial printer is printing correctly for date of shelf life, barcode, QR code coding, identifying marks Marking, raw materials and ingredients indicating on flexible Packaging or bag packaging for various products in the industrial manufacturing factory.<br>We’re looking forward to hearing various inquire in your manufacturing factory.' ?></p>
