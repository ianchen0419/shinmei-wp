<?php /* Template Name: inquiry_r__f */ ?>
<?php get_header();?>
...
<main id="contact">
	<div class="wrapper-size">
		...
		if ($_SESSION['finish']==true){
			...
			// $mailer->Username = "recruit@co-shinmei.com";     
			...
			// $mailer->AddReplyTo('recruit@co-shinmei.com');
			$mailer->setFrom('inquiry.workcapital@gmail.com', '株式会社シンメイ'); 
			// $mailer->setFrom('recruit@co-shinmei.com', '株式会社シンメイ'); 
			...
			$mailer->Body = 
				...
				'【御名前】'._post('your_name').'　'._post('your_name_furigana')."<br>".
				'【応募職種】'._post('your_job')."<br>".
			...
			$mailer->Subject = 'ホームページ）採用のお問い合わせ'; 
			$mailer->Body = 
				'各位'."<br><br>".
			...
			// $mailer->AddAddress('recruit@co-shinmei.com');
			$mailer->Send();
		}
