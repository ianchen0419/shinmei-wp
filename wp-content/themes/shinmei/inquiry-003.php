...
<main id="contact">
	<div class="wrapper-size">
		...
		<form action="<?php bloginfo('url') ?>/material/inquiry-003/conf" method="POST" class="mar_top40">
			<div class="contact-item">
				<div class="title">製品名</div>
				<p>卓上型 ロールフィルムダイレクトサーマルプリンター RPS</p>
			</div>
			...
			<div class="contact-item">
				<div class="title">包装する製品内容</div>
				<input type="text" name="product_content" />
			</div>
			<div class="contact-item">
				<div class="title">フィルムサイズ</div>
				<input type="text" name="film_size" placeholder="縦  mm・横  mm" />
			</div>
			<div class="contact-item">
				<div class="title">印字サイズ</div>
				<input type="text" name="print_size" placeholder="縦  mm・横  mm" />
			</div>
			<div class="contact-item">
				<div class="title">固定印字情報</div>
				<input type="text" name="print_fix" placeholder="＊製造者記号　＊バーコード等" />
			</div>
			<div class="contact-item">
				<div class="title">可変印字情報</div>
				<input type="text" name="print_change" placeholder="＊製造日　＊賞味期限　＊消費期限　＊ロット番号　＊トレーサビリティ記号など" />
			</div>
			<div class="contact-item">
